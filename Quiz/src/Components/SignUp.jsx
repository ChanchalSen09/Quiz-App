...
const Signup = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-50">
            <form onSubmit={handleSignup} className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg">
                ...
                <input
                    ...
                    required
                />
                <button type="submit" className="w-full px-4 py-3 font-bold text-white bg-blue-500 rounded hover:bg-blue-600" disabled={loading}>
