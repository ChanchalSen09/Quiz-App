...
const About = () => {
    return (
        <div className="max-w-4xl p-8 mx-auto mt-8 transition-transform transform bg-white border border-gray-200 rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl">
            <section className="mb-8">
                <h1 className="mb-6 text-4xl font-extrabold text-gray-800 animate-fadeIn">
                    About This Website
                </h1>

                <section className="mb-6">
                    <h2 className="mb-2 text-2xl font-semibold text-gray-700 animate-fadeIn">
                        Tech Stack
                    </h2>
                    ...
                    <ul className="ml-4 list-disc animate-fadeIn">
            ...
            <section className="mb-8">
                <h1 className="mb-6 text-4xl font-extrabold text-gray-800 animate-slideInRight">
                    About the Developer
                </h1>

                <section className="mb-6">
                    <h2 className="mb-2 text-2xl font-semibold text-gray-700 animate-slideInRight">
                        Chanchal Sen
                    </h2>
                    ...
                    <br></br>
                    <div className="flex space-x-6 animate-slideInRight">
                        ...
                        <a href="https://leetcode.com/u/Chanchalsen09/" target="_blank" rel="noopener noreferrer" className="transition-transform transform text-black-600 hover:text-pink-700 hover:scale-110">
                ...
                <section className="mb-6">
                    ...
                    <ul className="ml-4 list-disc animate-slideInRight">
